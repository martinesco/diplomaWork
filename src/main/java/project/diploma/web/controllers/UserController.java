...
import project.diploma.domain.models.binding.UserRegisterBindingModel;
import project.diploma.domain.models.service.UserServiceModel;
import project.diploma.domain.models.view.UserAllViewModel;
import project.diploma.domain.models.view.UserProfileViewModel;
import project.diploma.service.UserService;
import project.diploma.validation.user.UserEditValidator;
import project.diploma.validation.user.UserRegisterValidator;
...
public class UserController extends BaseController {
    ...
    @GetMapping("/edit")
    @PreAuthorize("isAuthenticated()")
    @PageTitle("Редактиране на профил")
